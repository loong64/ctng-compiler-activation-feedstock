...
FINAL_CFLAGS_linux_loongarch64="-ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O3 -pipe"
...
FINAL_CXXFLAGS_linux_loongarch64="-fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O3 -pipe"
...
FINAL_FFLAGS_linux_loongarch64="-fopenmp -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O3 -pipe"
...
FINAL_LDFLAGS_linux_loongarch64="-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--allow-shlib-undefined"
...
FINAL_LDFLAGS_LD_linux_loongarch64="-O2 --sort-common --as-needed -z relro -z now --allow-shlib-undefined"
...
FINAL_DEBUG_CFLAGS_linux_loongarch64="-ftree-vectorize -fPIC -fstack-protector-all -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe"
...
FINAL_DEBUG_CXXFLAGS_linux_loongarch64="-fvisibility-inlines-hidden -std=c++17 -fmessage-length=0 -ftree-vectorize -fPIC -fstack-protector-all -fno-plt -Og -g -Wall -Wextra -fvar-tracking-assignments -pipe"
...
FINAL_DEBUG_FFLAGS_linux_loongarch64="-fopenmp -ftree-vectorize -fPIC -fstack-protector-strong -pipe -Og -g -Wall -Wextra -fcheck=all -fbacktrace -fvar-tracking-assignments -pipe"
